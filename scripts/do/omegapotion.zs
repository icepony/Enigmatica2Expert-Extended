...
static potNameTag as IData[string] = {
  ...
  'mia:shrinking_potion1'                  : [ 99, 0,  100],
  'mia:shrinking_potion1_long'             : [ 99, 0,  200],
  'mia:shrinking_potion1_longer'           : [ 99, 0,  300],
  'mia:shrinking_potion2'                  : [ 99, 1,  100],
  'mia:shrinking_potion2_long'             : [ 99, 1,  200],
  'mia:shrinking_potion2_longer'           : [ 99, 1,  300],
  'mia:shrinking_potion3'                  : [ 99, 2,  100],
  'mia:shrinking_potion3_long'             : [ 99, 2,  200],
  'mia:growth_potion1'                     : [100, 0,  100],
  'mia:growth_potion1_long'                : [100, 0,  200],
  'mia:growth_potion1_longer'              : [100, 0,  300],
  'mia:growth_potion2'                     : [100, 1,  100],
  'mia:growth_potion2_long'                : [100, 1,  200],
  'mia:growth_potion2_longer'              : [100, 1,  300],
  'mia:growth_potion3'                     : [100, 2,  100],
  'mia:growth_potion3_long'                : [100, 2,  200],
  'mia:shrinking_venom'                    : [101, 0,  100],
  'mia:growth_venom'                       : [102, 0,  100],
  'mia:size_stabilization_potion'          : [103, 0, 2147483647],
  ...
  'extrautils2:xu2.doom'                   : [190, 0, 1200],
  'extrautils2:xu2.gravity'                : [191, 0, 1200],
  'extrautils2:xu2.gravity.long'           : [191, 0, 9600],
  'extrautils2:xu2.second.chance'          : [192, 0, 2400],
  'extrautils2:xu2.greek.fire'             : [193, 0, 2400],
  'extrautils2:xu2.fizzy.lifting'          : [194, 0,  600],
  'extrautils2:xu2.relapse'                : [195, 0, 9600],
  'extrautils2:xu2.love'                   : [196, 0,  200],
  'extrautils2:xu2.purging'                : [197, 0,    0],
  'rpsideas:psipulse'                      : [199, 0,  400],
  'rpsideas:psipulse_long'                 : [199, 0,  600],
  'rpsideas:psipulse_strong'               : [199, 1,  250],
  'rpsideas:psishock'                      : [201, 0,  160],
  'rpsideas:psishock_long'                 : [201, 0,  240],
  'rpsideas:psishock_strong'               : [201, 1,  125],
} as IData[string];
/**/
